...
from controllerautosystem import controllerAuto
...
author_lbl = tk.Label(main_frame, text="Made by word9317 \n Please use keybinds instead of buttons for starting, playback, and cancelling", fg="#AAAAAA", bg=BG_COLOR, font=("Arial", 9))
...
def create_button(text, command):
    return tk.Button(main_frame, text=text, command=command, bg=BTN_COLOR, fg=TEXT_COLOR, activebackground=BTN_ACTIVE, activeforeground=TEXT_COLOR, relief="flat", bd=0, height=2)
